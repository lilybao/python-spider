...
class Crawler():
    ...
    def post_request(self, url, params):
        ...
        data = {'params': '7s4X2g4u9gG5SNBOmwPmDxbCOXcmRoq3rUl94HMS403x7BOThtoZBOJCOwgqNfx20hLQghuf0q8NHj0t/CiFid6fdXZs7T3oE2l6BW+k6K9V7Jhcw1cY1HmRc/Qch1tFHhBOdtHNfPI8ifPMVc02kf/ErTVPKlnxk3K+cAPz6f0bvLC9LdRt3kG5tV4eDdnVjWDXGVa+lbMw0vnqeg0PLB1NL20W+UCcW9C28HwcNos=', 'encSecKey': ''}
    ...
    def search_song(self, song_name, song_num, quiet=True, limit=9):
        ...
        print(result['playlist']['tracks'][0]['name'])
...
class Netease():
    ...
    def download_song_by_search(self, song_name, song_num):
        ...
        try:
            result = self.crawler.search_song(song_name, song_num, self.quiet)
        except:
        ...
        counter = 1
        while counter <= n:
            ms=ms+"\n"+result['tracks'][counter]['name']
            counter +=1

        print(ms)
        if result != None:
           with open (music_list_name, 'w', encoding='utf-8') as f:
             f.write(str(ms))
             f.close()
